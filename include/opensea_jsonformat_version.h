...
#define OPENSEA_JSONFORMAT_VERSION COMBINE_JSONFORMAT_VERSIONS(OPENSEA_JSONFORMAT_MAJOR_VERSION,OPENSEA_JSONFORMAT_MINOR_VERSION,OPENSEA_JSONFORMAT_PATCH_VERSION)
