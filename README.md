...
## Cross platform library for processing json format output.

### Copyright (c) 2014-2024 Seagate Technology LLC and/or its Affiliates, All Rights Reserved

Welcome to opensea-jsonformat, part of the openSeaChest open source project!
...
Source code for opensea-jsonformat is available in this repo at [https://github.com/Seagate/opensea-jsonformat](https://github.com/Seagate/opensea-jsonformat).
