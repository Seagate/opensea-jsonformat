...
#define MAX_RAW_DATA_VALUE_IN_HEX_LENGTH         21
#define MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT  21
#define MAX_RAW_VALUE_OF_DOUBLE_IN_STRING_LENGHT 21
    ...
    json_object_object_add(attributeNode, "Attribute Type(s)", jarray);
    ...
    case THRESHOLD_ALWAYS_PASSING:
        json_object_object_add(attributeNode, "Threshold", json_object_new_string("Set to always passing"));
        break;
    case THRESHOLD_ALWAYS_FAILING:
        json_object_object_add(attributeNode, "Threshold", json_object_new_string("Set to always failing"));
        break;
    case THRESHOLD_INVALID:
        json_object_object_add(attributeNode, "Threshold", json_object_new_string("Set to invalid value"));
        break;
    case THRESHOLD_SET:
        if (smartAnalyzedAttribute.thresholdInfo.failStatus != FAIL_STATUS_NOT_SET)
        {
            ...
            json_object_object_add(
                thresholdNode, "Threshold Value",
                json_object_new_uint64(C_CAST(uint64_t, smartAnalyzedAttribute.thresholdInfo.thresholdValue)));
    ...
    // add raw data fields
    if (smartAnalyzedAttribute.rawData.userFieldCount > 0 || smartAnalyzedAttribute.rawData.boolAnalyzedValueValid ||
        smartAnalyzedAttribute.rawData.doubleAnalyzedValueValid ||
        smartAnalyzedAttribute.rawData.int64AnalyzedValueValid)
    {
        ...
        for (uint8_t field = 0; field < smartAnalyzedAttribute.rawData.userFieldCount; field++)
        {
            ...
            if (safe_strlen(unitString) > 0)
            {
                DECLARE_ZERO_INIT_ARRAY(char, fieldValue,
                                        (MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT +
                                         MAX_RAW_FEILD_UNIT_STRING_LENGTH)); // to be able to hold the unit string
                snprintf_err_handle(
                    fieldValue, (MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT + MAX_RAW_FEILD_UNIT_STRING_LENGTH),
                    "%" PRId64 " %s", smartAnalyzedAttribute.rawData.rawField[field].fieldValue, unitString);
            ...
            {
                DECLARE_ZERO_INIT_ARRAY(char, fieldValue, MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT);
                snprintf_err_handle(fieldValue, MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT, "%" PRId64 "",
        ...
        if (smartAnalyzedAttribute.rawData.doubleAnalyzedValueValid)
        {
            ...
            {
                DECLARE_ZERO_INIT_ARRAY(char, fieldValue,
                                        (MAX_RAW_VALUE_OF_DOUBLE_IN_STRING_LENGHT +
                                         MAX_RAW_FEILD_UNIT_STRING_LENGTH)); // to be able to hold the unit string
                snprintf_err_handle(fieldValue,
                                    (MAX_RAW_VALUE_OF_DOUBLE_IN_STRING_LENGHT + MAX_RAW_FEILD_UNIT_STRING_LENGTH),
            ...
            {
                DECLARE_ZERO_INIT_ARRAY(char, fieldValue, MAX_RAW_VALUE_OF_DOUBLE_IN_STRING_LENGHT);
                snprintf_err_handle(fieldValue, MAX_RAW_VALUE_OF_DOUBLE_IN_STRING_LENGHT, "%f",
            ...
            if (safe_strlen(unitString) > 0)
            {
                DECLARE_ZERO_INIT_ARRAY(char, fieldValue,
                                        (MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT +
                                         MAX_RAW_FEILD_UNIT_STRING_LENGTH)); // to be able to hold the unit string
                snprintf_err_handle(fieldValue,
                                    (MAX_RAW_VALUE_OF_INT64_IN_STRING_LENGHT + MAX_RAW_FEILD_UNIT_STRING_LENGTH),
        ...
        {
            json_object_object_add(rawDataNode, smartAnalyzedAttribute.rawData.boolAnalyzedString, M_NULLPTR);
        }

        // add raw 0:7 bytes in hex
    ...
    else
    {
        ...
        snprintf_err_handle(rawDataValue, MAX_RAW_DATA_VALUE_IN_HEX_LENGTH,
                            ...
                            smartAnalyzedAttribute.rawData.rawData[2], smartAnalyzedAttribute.rawData.rawData[1],
                            smartAnalyzedAttribute.rawData.rawData[0]);
        json_object_object_add(attributeNode, "Raw Data", json_object_new_string(rawDataValue));
    }
